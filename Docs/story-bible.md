# Echoes of Neon — Story Bible

**Status: first draft, built directly from Orlando's answers to
`Docs/Story/Narrative/story-intake-form.md` (recorded 2026-09-13 in
`Echoes_of_Neon_Story_Intake.docx`). Review and correct before treating any of this
as locked.** Anywhere this document goes beyond what was explicitly answered, it says
so — nothing here should be read as a new creative decision made without Orlando.

## Premise

New Carthage is a rain-slicked, neon-lit industrial metropolis that Aegis-Corvus
Dynamics has ruled for over a decade under its founder and CEO, known only as **The
Madame** — a woman who has never once let profit take a back seat to the people in her
streets. Marcus "Echo" Cross was a military breach specialist and industrial
contractor until Aegis-Corvus murdered his wife Desdemona, stole her neural research,
and destroyed his eyes to bury what she'd found. Rebuilt with a black-market
cybernetic perception suite, Marcus now moves through New Carthage at night, hunting
the truth about what happened to Desi and the person at the top of the company that
took her — while a small, secretive resistance works the same target from the other
direction, trying to expose a decade of a city being run for a profit that never
reaches the people paying for it.
...
- Grounded and gritty. Very little humor.
- **Not** a found-family story — Marcus's core relationships (Max, the resistance) are
  real but this isn't a story about him gaining a new family to replace the one he
  lost.
- Supernatural elements are woven throughout, not saved for a last-minute swerve —
  they build toward a supernatural twist at the ending, so they should read as part of
  the world from early on, not a genre left-turn.

## Structure

Three main missions plus one bonus mission. Each main mission has a minimum of three
sub-missions. **Mid-story beats are not yet specified beyond the opening and ending**
below — the act structure here is a scaffold for where those sub-missions will live,
not a claim about what happens in them.

- **Act 1 — Opening** (see `Docs/Story/Scenes/01-opening-dream-and-waking.md`): Marcus
  dreams of Desi before the accident, wakes in her old lab disoriented and afraid of
  what his own augments are costing him, and resolves — again — to go after the head
  of Aegis-Corvus Dynamics specifically, not the company in the abstract.
- **Act 2 — The three main missions.** Structurally, this is where Marcus's manhunt
  and the resistance's expose converge, each main mission presumably bringing him a
  step closer to The Madame and to Desi's research (inferred from the premise, not
  yet confirmed scene-by-scene). Locations established for this act:
  New Carthage's night streets, the black market augment scene, Max's builder-contact
